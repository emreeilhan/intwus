...
const row = {
  ...
  tag: 'Aarhus, DK',
  focus: 'Systems,Hardware,Embedded'
};
...
if (!exists) {
  const notes = '2026 Summer | Nordic HQ; systems/embedded fit. Initiative application.';
  insert.run(row.company, 'Researching', notes, row.website, row.tag, 'High', row.focus);
}
...
console.log('Inserted Vestas if not existing.');
